    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
              'assets/images/reefscape/karthik-reef-diagram-top.png'), // Replace with your image path
          fit: BoxFit.cover,
        ),
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          CounterNumberField(
              margin: EdgeInsets.only(right: 100.0, top: 70.0, left: 100.0),
          ...
          CounterNumberField(
              margin: EdgeInsets.only(right: 100.0, top: 70.0),
